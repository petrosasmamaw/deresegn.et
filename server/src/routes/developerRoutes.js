...
router.get('/keys', authenticateUser, async (req, res) => {
  try {
...
router.post('/keys', authenticateUser, async (req, res) => {
  try {
...
router.post('/keys/:id/renew', authenticateUser, async (req, res) => {
  try {
    const packageId = req.body.packageId?.trim();
...
router.post('/keys/:id/revoke', authenticateUser, async (req, res) => {
  try {
